...
class NativeWasmModule implements WasmModule {
  ...
  external void wire_get_nutrition(NativePortType port_, int item);

  external void wire_search_local_items(NativePortType port_, String input);
}
...
class NativeWire extends FlutterRustBridgeWasmWireBase<NativeWasmModule> {
  ...
  void wire_get_nutrition(NativePortType port_, int item) =>
      wasmModule.wire_get_nutrition(port_, item);

  void wire_search_local_items(NativePortType port_, String input) =>
      wasmModule.wire_search_local_items(port_, input);
}
